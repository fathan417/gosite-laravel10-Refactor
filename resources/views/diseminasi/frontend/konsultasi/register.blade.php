  ...
  <div class="container">
      <div class="row justify-content-between align-items-center">
          ...
          <div class="col-12 col-md-5 order-1 order-lg-2">
                <h1 class="display-2 mb-3">Konsultasi Statistik Online</h1>
                <p class="lead">BPS Provinsi Gorontalo menyediakan layanan konsultasi statistik secara <i>online</i> melalui <i>video conference</i> menggunakan aplikasi <a  target="_blank" href="https://play.google.com/store/apps/details?id=us.zoom.videomeetings&hl=en&gl=US">ZOOM</a>.</p> 
                <p class="lead">Silakan daftar melalui form berikut ini.</p>
                <div class="mt-4">
                  <form action="{{asset(route('diseminasi.konsultasi.register.save',[],false))}}" class="d-flex flex-column mb-5 mb-lg-0" method="POST">
                      @csrf
                      ...
                      <label for="tgl_konsultasi">Waktu Konsultasi:<sup>*</sup></label>
                          ...
                          <div class="input-group-prepend">
                            ...
                            <select name="waktu_konsultasi" id="waktu_konsultasi" class="form-control" aria-describedby="inputGroup-sizing-default" >
                              ...
                              <option {{old('waktu_konsultasi')=='15:00'?'selected':''}} value="15:00">16:00</option>
                              <option {{old('waktu_konsultasi')=='15:00'?'selected':''}} value="15:00">17:00</option>
                              <option {{old('waktu_konsultasi')=='15:00'?'selected':''}} value="15:00">18:00</option>
                              <option {{old('waktu_konsultasi')=='15:00'?'selected':''}} value="15:00">19:00</option>
                              <option {{old('waktu_konsultasi')=='15:00'?'selected':''}} value="15:00">20:00</option>
                            </select>
                            </select>
