        ...
        <div class="container">
            ...
            <div class="navbar-collapse collapse" id="navbar_global">
                ...
                <ul class="navbar-nav ml-auto">
                    <li class="nav-item">
                        <a class="nav-link nav-link-icon" href="{{asset(route('diseminasi.konsultasi.index', [], false))}}">
                            Konsultasi Statistik
                        </a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link nav-link-icon" href="{{asset(route('diseminasi.broadcast.register', [], false))}}">
                            Broadcast Informasi Statistik
                        </a>
                    </li>
                </ul>
            </div>
